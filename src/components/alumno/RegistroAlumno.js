...
import { TextField, Button, Container, Typography, Paper, Grid, CssBaseline, InputAdornment, IconButton } from '@mui/material';
          ...
          <Grid container spacing={2} alignItems="center">
            ...
            <Grid item xs={8} md={2}>
              <Typography style={{ marginBottom: 10 }}>
                Usted se está registrando como <span style={{ color: '#355389' }}><b>alumno</b></span>.
              </Typography>
            </Grid>
          </Grid>
