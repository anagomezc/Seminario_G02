    ...
    return (
        <div className="body">
            ...
            <div className="d-flex p-4 border-bottom mb-4">
                ...
                <div className="w-100 text-center title"><p>Generar didácticas</p></div>
            </div>
            <Alert icon={false} severity="info">Generemos algunas didácticas o actividades de clase basadas en el tema que indique.</Alert>
            <div>
                <div className="d-flex flex-column text-left p-3">
                    ...
                    <TextField
                        ...
                        placeholder="Por ejemplo, 'actividades de cálculo de área de formas geométricas'..."
                        variant="outlined"
                        fullWidth
