    ...
    return (
        <div className="body">
            ...
            <div className="d-flex p-4 border-bottom mb-4">
                ...
                <div className="w-100 text-center title"><p>Buscar herramientas</p></div>
            </div>
            <Alert icon={false} severity="info">Ingresa tu necesidad e identifiquemos algunas herramientas que puedan ayudarte en el aula. </Alert>
            <div>
                <div className="d-flex flex-column text-left p-3">
                    ...
                    <TextField
                        ...
                        placeholder="Por ejemplo, 'evaluar conceptos teóricos de geometría'..."
                        variant="outlined"
                        fullWidth
            ...
            <Modal
                ...
                <Box sx={style}>
                    <Typography id="modal-modal-title" variant="h5" component="h2">
                        Se han generado herramientas con su tema seleccionado!
                    </Typography>
